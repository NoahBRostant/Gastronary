...
/** @type {string} */
const CACHE_VERSION = '1742648834|6622669680';
/** @type {string} */
const CACHE_PREFIX = 'Gastronary-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Gastronary.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Gastronary.html","Gastronary.js","Gastronary.offline.html","Gastronary.icon.png","Gastronary.apple-touch-icon.png","Gastronary.audio.worklet.js","Gastronary.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Gastronary.wasm","Gastronary.pck"];
